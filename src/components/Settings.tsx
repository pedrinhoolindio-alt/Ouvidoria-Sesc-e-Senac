      ...
      <div className="bg-white rounded-[20px] shadow-[0_10px_15px_rgba(0,0,0,0.05)] p-8 border border-[#E2E8F0]">
        ...
        <form onSubmit={handleSave} className="space-y-6">
          <div className="space-y-2">
            ...
            />
            <p className="text-[10px] text-[#94A3B8]">Recomendado: Imagens em alta resolução (1920x1080)</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <input 
              ...
              className="w-full p-3.5 border border-[#E2E8F0] rounded-xl outline-none focus:ring-2 focus:ring-[#003F7F]/10 text-sm"
            />
            <p className="text-[10px] text-[#94A3B8]">Recomendado: Imagem quadrada com fundo transparente (PNG)</p>
          </div>
        ...
        <div className="mt-10 pt-10 border-t border-[#F1F5F9]">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <span className="text-[10px] text-[#94A3B8]">Logomarca atual:</span>
              <div className="h-24 bg-[#F8FAFC] rounded-xl flex items-center justify-center border border-dashed border-[#CBD5E1]">
                <img src={logoUrl} alt="Preview Logo" className="h-16 object-contain" />
              </div>
            </div>
            <div className="space-y-2">
              <span className="text-[10px] text-[#94A3B8]">Fundo atual:</span>
              <div 
                className="h-24 bg-cover bg-center rounded-xl border border-dashed border-[#CBD5E1]"
